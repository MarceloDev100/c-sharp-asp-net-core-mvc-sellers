...
namespace SalesWebMvc.Data
{
    public class SeedingService : ISeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s4 = new Seller(4, "Martha", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
